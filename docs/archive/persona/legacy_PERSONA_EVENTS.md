# SUBORDINATE DOCUMENT — Non-authoritative persona events

This document has been moved to docs/persona/legacy/PERSONA_EVENTS.md and is preserved here as a historical, non-authoritative reference.
