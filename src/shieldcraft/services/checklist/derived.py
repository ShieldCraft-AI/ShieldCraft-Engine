...
def infer_tasks(item):
    ...
    if item_type == "module":
        ...
        derived.append({"id": _make_deterministic_id(base_id,
                                                     "module_test",
                                                     test_payload),
                        "ptr": f"{ptr}/test",
                        ...
                        "meta": {"parent_id": base_id,
                                 "derived_type": "module_test",
                                 "source": "derived",
                                 "derived_from": base_id,
                                 "justification": "derived_module_test",
                                 "justification_ptr": parent_spec_ptr,
        ...
        derived.append({"id": _make_deterministic_id(base_id,
                        ...
                        "source_node_type": parent_node_type,
                        "meta": {"parent_id": base_id,
                                 "derived_type": "module_imports",
                                 "source": "derived",
                                 "derived_from": base_id,
                                 "justification": "derived_module_imports",
                                 "justification_ptr": parent_spec_ptr,
                                 "inference_type": "structural"}})
        ...
        derived.append({"id": _make_deterministic_id(base_id,
                        ...
                        "source_node_type": parent_node_type,
                        "meta": {"parent_id": base_id,
                                 "derived_type": "module_init",
                                 "source": "derived",
                                 "derived_from": base_id,
                                 "justification": "derived_module_init",
                                 "justification_ptr": parent_spec_ptr,
                                 "inference_type": "structural"}})
    ...
    if category == "bootstrap":
        ...
        derived.append({"id": _make_deterministic_id(base_id,
                        ...
                        "source_node_type": parent_node_type,
                        "meta": {"parent_id": base_id,
                                 "derived_type": "bootstrap_impl",
                                 "source": "derived",
                                 "derived_from": base_id,
                                 "justification": "derived_bootstrap_impl",
                                 "justification_ptr": parent_spec_ptr,
                                 "inference_type": "structural"}})
        ...
        derived.append({"id": _make_deterministic_id(base_id,
                        ...
                        "source_node_type": parent_node_type,
                        "meta": {"parent_id": base_id,
                                 "derived_type": "bootstrap_verify",
                                 "source": "derived",
                                 "derived_from": base_id,
                                 "justification": "derived_bootstrap_verify",
                                 "justification_ptr": parent_spec_ptr,
                                 "inference_type": "structural"}})
            ...
            for dep in depends_on:
                ...
                derived.append({"id": _make_deterministic_id(base_id,
                               ...
                               "unknown"),
                                ...
                                "source_node_type": parent_node_type,
                                "meta": {"parent_id": base_id,
                                         "derived_type": "fix-dependency",
                                         "dependency": dep,
                                         "source": "derived",
                                         "derived_from": base_id,
                                         "justification": "derived_fix_dependency",
                                         "inference_type": "structural"}})
        ...
        derived.append(
            {
                ...
                "meta": {
                    "parent_id": base_id,
                    "derived_type": "resolve-invariant",
                    "invariant_id": invariant_id,
                    "derived_from": base_id,
                    "justification": f"resolve_invariant:{invariant_id}",
                    "inference_type": "structural"}})
